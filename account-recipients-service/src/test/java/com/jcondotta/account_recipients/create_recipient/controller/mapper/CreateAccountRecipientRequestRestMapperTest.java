...
class CreateAccountRecipientRequestRestMapperTest {
  ...
  private static final String RECIPIENT_NAME_STRING = AccountRecipientFixtures.JEFFERSON.getRecipientName();
  ...
  void shouldMapToCommand_whenRequestIsValid() {
    ...
    CreateAccountRecipientCommand command = mapper.toCommand(BANK_ACCOUNT_UUID, request);
