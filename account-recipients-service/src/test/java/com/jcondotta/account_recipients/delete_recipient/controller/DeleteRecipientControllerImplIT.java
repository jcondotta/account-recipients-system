...
import static com.jcondotta.account_recipients.domain.exceptions.BankAccountNotFoundException.BANK_ACCOUNT_NOT_FOUND_TEMPLATE;
import static com.jcondotta.account_recipients.domain.exceptions.BankAccountNotFoundException.BANK_ACCOUNT_NOT_FOUND_TITLE;
import static com.jcondotta.account_recipients.domain.exceptions.RecipientNotFoundException.RECIPIENT_NOT_FOUND_TEMPLATE;
import static com.jcondotta.account_recipients.domain.exceptions.RecipientNotFoundException.RECIPIENT_NOT_FOUND_TITLE;
...
class DeleteRecipientControllerImplIT {
  ...
  private AccountRecipientEntity seed(Recipient recipient) {
