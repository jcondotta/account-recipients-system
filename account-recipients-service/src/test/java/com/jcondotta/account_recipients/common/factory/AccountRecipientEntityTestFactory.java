...
public class AccountRecipientEntityTestFactory {
  ...
  public static AccountRecipientEntity create(UUID recipientId, UUID bankAccountId, String recipientName, String iban, Clock clock) {
    return new AccountRecipientEntity(recipientId, bankAccountId, recipientName, iban, ZonedDateTime.now(clock));
  }
