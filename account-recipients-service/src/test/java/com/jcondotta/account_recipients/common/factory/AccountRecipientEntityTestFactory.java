...
public class AccountRecipientEntityTestFactory {
  ...
  public static AccountRecipientEntity create(
      UUID accountRecipientId, UUID bankAccountId, String recipientName, String iban, Clock clock) {
    return new AccountRecipientEntity(
        accountRecipientId, bankAccountId, recipientName, iban, ZonedDateTime.now(clock));
  }

  public static AccountRecipientEntity create(
      UUID bankAccountId, String recipientName, String iban, Clock clock) {
    return create(UUID.randomUUID(), bankAccountId, recipientName, iban, clock);
  }

  public static AccountRecipientEntity create(
      UUID bankAccountId, String recipientName, Clock clock) {
  ...
  public static AccountRecipientEntity create(UUID bankAccountId, String recipientName) {
    return create(
        UUID.randomUUID(), bankAccountId, recipientName, Iban.random().toString(), DEFAULT_CLOCK);
  }
}
