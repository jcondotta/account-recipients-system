package com.jcondotta.recipients.application.ports.output.repository.get_recipients.model;
...
class GetRecipientsQueryParamsTest {

  private static final QueryLimit QUERY_LIMIT_DEFAULT =
      QueryLimit.of(GetRecipientsQueryParams.DEFAULT_LIMIT);
  private static final QueryLimit QUERY_LIMIT_10 = QueryLimit.of(10);

  private static final PaginationCursor PAGINATION_CURSOR =
      PaginationCursor.of("encoded-cursor-123");
  ...
  void shouldCreateQueryParamsWithDefaultQueryLimit_whenLimitIsNull() {
    var queryParams = GetRecipientsQueryParams.of(null, null, PAGINATION_CURSOR);
    assertThat(queryParams)
        .satisfies(
            params -> {
  ...
  void shouldCreateQueryParamsWithNamePrefixNull_whenNamePrefixIsNull() {
    var queryParams = GetRecipientsQueryParams.of(QUERY_LIMIT_10, null, PAGINATION_CURSOR);
    assertThat(queryParams)
        .satisfies(
            params -> {
              assertThat(params.limit()).isEqualTo(QUERY_LIMIT_10);
  ...
  void shouldCreateQueryParamsWithCursorNull_whenCursorIsNull() {
    var queryParams =
        GetRecipientsQueryParams.of(QUERY_LIMIT_10, RECIPIENT_NAME_PREFIX, null);
    assertThat(queryParams)
        .satisfies(
            params -> {
              assertThat(params.limit()).isEqualTo(QUERY_LIMIT_10);
  ...
  void shouldCreateQueryParamsWithQueryLimitFactoryMethod_whenQueryLimitIsValid() {
    var queryParams = GetRecipientsQueryParams.of(QUERY_LIMIT_10);
    assertThat(queryParams)
        .satisfies(
            params -> {
              assertThat(params.limit()).isEqualTo(QUERY_LIMIT_10);
  ...
  void shouldCreateQueryParamsWithQueryLimitFactoryMethod_whenQueryLimitIntegerIsValid() {
    ...
    var queryParams = GetRecipientsQueryParams.of(queryLimitInteger);
    assertThat(queryParams)
        .satisfies(
            params -> {
              assertThat(params.limit()).isEqualTo(QUERY_LIMIT_10);
  ...
  void shouldNotBeEqual_whenFieldsDiffer() {
    ...
    var params1 =
        GetRecipientsQueryParams.of(
            QUERY_LIMIT_10, RECIPIENT_NAME_PREFIX, PAGINATION_CURSOR);
    var params2 =
        GetRecipientsQueryParams.of(QUERY_LIMIT_DEFAULT, RECIPIENT_NAME_PREFIX, cursor2);
