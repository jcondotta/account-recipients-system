package com.jcondotta.recipients.application.ports.output.repository.shared.model;
...
public record PaginatedResult<T>(List<T> items, String nextCursor) {
  ...
  public static final String NEXT_CURSOR_NOT_EMPTY_MESSAGE =
      "nextCursor must not be empty when present";
