...
class BankAccountIdTest {
  ...
  private static final UUID BANK_ACCOUNT_UUID_1 =
      UUID.fromString("1fcaca1b-92ba-43c1-b45c-bacf92868d31");
  private static final UUID BANK_ACCOUNT_UUID_2 =
  ...
  void shouldBeEqual_whenBankAccountIdsHaveSameValue() {
    ...
    assertThat(bankAccountId1).isEqualTo(bankAccountId2).hasSameHashCodeAs(bankAccountId2);
  }
