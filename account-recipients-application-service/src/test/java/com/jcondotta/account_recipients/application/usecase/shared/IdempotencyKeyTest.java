...
class IdempotencyKeyTest {
  ...
  private static final UUID IDEMPOTENCY_KEY_UUID_1 =
      UUID.fromString("1fcaca1b-92ba-43c1-b45c-bacf92868d31");
  private static final UUID IDEMPOTENCY_KEY_UUID_2 =
  ...
  void shouldBeEqual_whenIdempotencyKeysHaveSameValue() {
    ...
    assertThat(idempotencyKey1).isEqualTo(idempotencyKey2).hasSameHashCodeAs(idempotencyKey2);
  }
