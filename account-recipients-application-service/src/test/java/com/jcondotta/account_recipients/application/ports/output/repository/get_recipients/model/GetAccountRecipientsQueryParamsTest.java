...
class GetAccountRecipientsQueryParamsTest {
  ...
  private static final QueryLimit QUERY_LIMIT_DEFAULT =
      QueryLimit.of(GetAccountRecipientsQueryParams.DEFAULT_LIMIT);
  ...
  void shouldCreateQueryParamsWithCursorNull_whenCursorIsNull() {
    var queryParams =
        GetAccountRecipientsQueryParams.of(QUERY_LIMIT_10, RECIPIENT_NAME_PREFIX, null);
    assertThat(queryParams)
        .satisfies(
            params -> {
              assertThat(params.limit()).isEqualTo(QUERY_LIMIT_10);
  ...
  void shouldNotBeEqual_whenFieldsDiffer() {
    ...
    var params1 =
        GetAccountRecipientsQueryParams.of(
            QUERY_LIMIT_10, RECIPIENT_NAME_PREFIX, PAGINATION_CURSOR);
    var params2 =
        GetAccountRecipientsQueryParams.of(QUERY_LIMIT_DEFAULT, RECIPIENT_NAME_PREFIX, cursor2);
