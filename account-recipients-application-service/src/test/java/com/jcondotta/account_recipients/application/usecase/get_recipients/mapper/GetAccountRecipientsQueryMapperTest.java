...
//                assertAll(
//                    () ->
//                        assertThat(details.recipientId())
//                            .isEqualTo(accountRecipient.getRecipientId()),
//                    () ->
//                        assertThat(details.bankAccountId())
//                            .isEqualTo(accountRecipient.getBankAccountId()),
//                    () ->
//                        assertThat(details.recipientName())
//                            .isEqualTo(accountRecipient.getRecipientName()),
