...
public record DeleteAccountRecipientCommand(
    BankAccountId bankAccountId, AccountRecipientId accountRecipientId) {
  ...
  public static DeleteAccountRecipientCommand of(
      BankAccountId bankAccountId, AccountRecipientId accountRecipientId) {
