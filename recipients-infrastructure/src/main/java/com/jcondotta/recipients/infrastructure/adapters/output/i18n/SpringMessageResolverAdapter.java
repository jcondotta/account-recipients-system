package com.jcondotta.recipients.infrastructure.adapters.output.i18n;
...
public class SpringMessageResolverAdapter implements MessageResolverPort {
  ...
  public SpringMessageResolverAdapter(@Qualifier("errorMessageSource") MessageSource messageSource) {
