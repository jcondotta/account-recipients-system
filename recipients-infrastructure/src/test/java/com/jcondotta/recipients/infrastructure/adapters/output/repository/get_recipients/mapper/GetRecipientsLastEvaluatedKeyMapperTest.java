...
class GetRecipientsLastEvaluatedKeyMapperTest {
    ...
    assertThat(map)
        ...
        .satisfies(
            it -> {
              ...
              var rn =
                  it.get(GetRecipientsLastEvaluatedKeyMapper.RECIPIENT_NAME_LSI_PARAM_NAME).s();
  ...
  void shouldExtractBankAccountId_whenPartitionKeyExists() {
    ...
    var map =
        Map.of(
            GetRecipientsLastEvaluatedKeyMapper.PARTITION_KEY_PARAM_NAME, AttributeValue.fromS(pk));
