...
class RecipientEntityMapperTest {
        ...
        .satisfies(
            entity -> {
              assertThat(entity.getPartitionKey())
                  .isEqualTo(RecipientEntityKey.partitionKey(BANK_ACCOUNT_ID));
              assertThat(entity.getSortKey())
                  .isEqualTo(RecipientEntityKey.sortKey(ACCOUNT_RECIPIENT_ID));
  ...
  void shouldMapEntityToDomain_whenValidEntity() {
    ...
    entity.setPartitionKey(RecipientEntityKey.partitionKey(BANK_ACCOUNT_ID));
    entity.setSortKey(RecipientEntityKey.sortKey(ACCOUNT_RECIPIENT_ID));
