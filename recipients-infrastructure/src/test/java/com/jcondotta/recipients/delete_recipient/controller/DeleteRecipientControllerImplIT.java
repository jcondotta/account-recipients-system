...
import com.jcondotta.recipients.infrastructure.interfaces.rest.exception_handler.ProblemTypes;
...
import static com.jcondotta.recipients.domain.exceptions.BankAccountNotFoundException.BANK_ACCOUNT_NOT_FOUND_TEMPLATE;
import static com.jcondotta.recipients.domain.exceptions.BankAccountNotFoundException.BANK_ACCOUNT_NOT_FOUND_TITLE;
import static com.jcondotta.recipients.domain.exceptions.RecipientNotFoundException.RECIPIENT_NOT_FOUND_TEMPLATE;
import static com.jcondotta.recipients.domain.exceptions.RecipientNotFoundException.RECIPIENT_NOT_FOUND_TITLE;
...
class DeleteRecipientControllerImplIT {
  ...
  void beforeEach(@LocalServerPort int port) {
    ...
    recipientName = RecipientName.of(RecipientFixtures.JEFFERSON.getRecipientName());
